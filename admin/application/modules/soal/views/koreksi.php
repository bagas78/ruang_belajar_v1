<header class="page-header">
  <div class="container-fluid">
    <h2 class="no-margin-bottom">Koreksi Uraian</h2>
  </div>
</header>
					...
					<tbody>
						<?php foreach ($uraian as $key => $var): ?>
							<tr>
								...
								<td>
									<a href="<?php echo base_url("soal/koreksi_soal/".$var['soal_uraian_detail_id']) ?>" class="btn btn-warning text-light"><i class="fas fa-edit"></i> Koreksi</a>
								</td>
							</tr>
						<?php endforeach ?>
					</tbody>
