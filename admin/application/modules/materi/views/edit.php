...
<div class="container mt-4">
  <div class="card">
        ...
        <div class="card-body">
          <div class="preview">
            <p>Preview</p>
            <img id="preview" class="img img-thumbnail" style="width: 128px; height: auto;" src="<?= (!empty($materi['materi_foto']) ? base_url('assets/uploads/'.$materi['materi_foto']."?".time()) : base_url('assets/uploads/default-image.jpg')) ?>">
          </div>
          <div></div>
          <form class="mt-4" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
              ...
              <input autocomplete="off" id="materi" name="materi" type="text" value="<?php echo $materi['materi_judul'] ?>" placeholder="Judul materi" class="form-control" required="">
            </div>
            <div class="form-group">       
              <label class="form-control-label">Post</label>
              <textarea required="" id="post" name="post" class="form-control" style="height: 450px"><?php echo $materi['materi_post'] ?></textarea>
            </div>
            <div class="form-group">       
