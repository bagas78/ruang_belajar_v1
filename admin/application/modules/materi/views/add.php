...
<div class="container mt-4">
  <div class="card">
        ...
        <div class="card-body">
          <div class="preview">
            <p>Preview</p>
            <img id="preview" class="img img-thumbnail" style="width: 128px; height: auto;" src="<?=base_url('assets/uploads/default-image.jpg') ?>">
          </div>
          <div></div>
          <form class="mt-4" method="post" action="<?php echo base_url("materi/post") ?>" enctype="multipart/form-data">
            <div class="form-group">
              <label class="form-control-label">Gambar</label>
              <input required="" accept=".jpg, .jpeg" id="gambar" name="gambar" type="file" placeholder="Pilih gambar" class="form-control">
            </div>
            <div class="form-group">
              <label class="form-control-label">Judul Materi</label>
              <input autocomplete="off" id="materi" name="materi" type="text" placeholder="Judul materi" class="form-control" required="">
            </div>
            <div class="form-group">       
              <label class="form-control-label">Post</label>
              <textarea required="" id="post" name="post" class="form-control" style="height: 450px"></textarea>
            </div>
            <div class="form-group">       
